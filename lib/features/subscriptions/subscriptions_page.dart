              ...
              card(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 8),
                    _slider(context, '保留前 N 名 (按质量, 0=全部)', cfg.subLatencyTopN.toDouble(), 0, 500,
              ...
              card(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 8),
                    _slider(context, '每节点测速次数(取中位数)', cfg.subSpeedProbes.toDouble(), 1, 5,
                        (v) => _save(cfg.copyWith(subSpeedProbes: v.round()))),
                    const SizedBox(height: 8),
                    _doubleSlider(context, '下载大小 (MB)', cfg.subSpeedSizeMb, 0.1, 10,
                        (v) => _save(cfg.copyWith(subSpeedSizeMb: v))),
                    const SizedBox(height: 8),
                    _doubleSlider(context, '带宽参考值 (Mbps, 达此值满分)', cfg.subBandwidthRefMbps, 5, 100,
                        (v) => _save(cfg.copyWith(subBandwidthRefMbps: v))),
                  ],
                ),
              ),
            ],
